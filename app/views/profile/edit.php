...
<div style="max-width: 600px; margin: 3rem auto; padding: 0 5%;">
    <div style="background: white; padding: 3rem; border-radius: 30px; box-shadow: 0 20px 60px rgba(0,0,0,0.05);">
        ...
        <!-- VULNERABILITY: Mass Assignment & UNRESTRICTED FILE UPLOAD -->
        <form action="/profile/edit" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 1.5rem;">
                <label style="display: block; font-weight: 700; font-size: 0.8rem; color: #555; text-transform: uppercase; margin-bottom: 0.5rem;">Profile Photo (Unrestricted Upload)</label>
                <input type="file" name="avatar" class="glass-input">
            </div>
