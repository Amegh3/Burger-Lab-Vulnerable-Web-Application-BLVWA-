    ...
    <div style="background: white; padding: 3rem; border-radius: 30px; box-shadow: 0 10px 40px rgba(0,0,0,0.05);">
        <form action="#" method="POST">
            ...
            <div style="margin-bottom: 2rem;">
                ...
                <textarea placeholder="e.g. Birthday celebration, window seat..." class="glass-input" style="height: 100px;"></textarea>
            </div>
