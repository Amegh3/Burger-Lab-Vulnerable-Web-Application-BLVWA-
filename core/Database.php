...
class MockPDO
{
    ...
    public $users = [
        ...
        [
            ...
            'employee_id' => 'GUEST-000',
            'password_hash' => 'guest', 
            'email' => 'guest@gmail.com', 
            'role' => 'customer', 
            'wallet_balance' => 5000.00,
            'avatar' => '/assets/images/customer_avatar.png',
            'location' => 'Pattom Palace area, Trivandrum',
            'member_since' => 'May 2026',
            'achievements' => ['First Order'],
        ...
        [
            ...
            'username' => 'owner', 
            'full_name' => ' CEO',
            'employee_id' => 'BL-EXE-001',
            'password_hash' => 'owner', 
            'email' => 'Ceo@burgerlabs.com', 
            'role' => 'owner', 
            'wallet_balance' => 1500000.00,
            'avatar' => '/assets/images/owner_avatar.png',
            'location' => 'Vellayambalam area, Trivandrum',
            'member_since' => 'Oct 2023',
            'achievements' => ['Visionary Founder', 'Investor Choice'],
        ...
        [
            ...
            'username' => 'alex', 
            'full_name' => 'Alex IM',
            'employee_id' => 'BL-STAFF-004',
            'password_hash' => 'alex', 
            'email' => 'alex.idicula@burgerlabs.com', 
            'role' => 'staff', 
            'wallet_balance' => 25000.00,
            'avatar' => '/assets/images/chef_avatar.png',
            'location' => 'Ambalamukku Junction, Trivandrum',
            'member_since' => 'Mar 2024',
            'achievements' => ['Best Performer 2025', 'Master Chef'],
        ...
        [
            ...
            'username' => 'abhinand', 
            'full_name' => 'Abhinand ',
            'employee_id' => 'BL-STAFF-005',
            'password_hash' => 'abhinand', 
            'email' => 'abhinand.manager@burgerlabs.com', 
            'role' => 'staff', 
            'wallet_balance' => 18000.00,
            'avatar' => '/assets/images/face3.png',
            'location' => 'Kowdiar Junction, Trivandrum',
            'member_since' => 'Jun 2024',
            'achievements' => ['Efficiency Star', 'Manager of the Month'],
        ...
        [
            ...
            'username' => 'nikhil', 
            'full_name' => 'Nikhil S.',
            'employee_id' => 'BL-STAFF-006',
            'password_hash' => 'nikhil', 
            'email' => 'nikhil.burger@burgerlabs.htb', 
            'role' => 'staff', 
            'wallet_balance' => 8000.00,
            'avatar' => '/assets/images/staff_avatar_1.png',
            'location' => 'Kazhakkoottam West, Trivandrum',
            'member_since' => 'Jan 2025',
            'achievements' => ['Burger Specialist'],
        ...
        [
            ...
            'employee_id' => 'BL-STAFF-007',
            'password_hash' => 'vishnu', 
            'email' => 'vishnu.cashier@burgerlabs.com', 
            'role' => 'staff', 
            'wallet_balance' => 12000.00,
            'avatar' => '/assets/images/staff_avatar_2.png',
            'location' => 'Sasthamangalam area, Trivandrum',
            'member_since' => 'Feb 2025',
            'achievements' => ['Customer Favorite', 'Top Seller'],
